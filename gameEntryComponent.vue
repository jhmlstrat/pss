...
{{ tmpPlay }}
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="1" v-show="tmpPlay != 'S2' && tmpPlay != 'S**'  && tmpPlay != 'D2'  && tmpPlay != 'D**' && tmpPlay != 'D3' && tmpPlay != 'D***' && tmpPlay != 'T3' && tmpPlay != 'F1' && tmpPlay != 'F2' && tmpPlay != 'F3'">Pitcher</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="2" v-show="tmpPlay != 'S2' && tmpPlay != 'S**'  && tmpPlay != 'D2'  && tmpPlay != 'D**' && tmpPlay != 'D3' && tmpPlay != 'D***' && tmpPlay != 'T3' && tmpPlay != 'F1' && tmpPlay != 'F2' && tmpPlay != 'F3'">Catcher</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="3" v-show="tmpPlay == 'E' || tmpPlay == 'S1' || tmpPlay == 'S*' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'gbA' || tmpPlay == 'G1' || tmpPlay == 'gbB' || tmpPlay == 'G2' || tmpPlay == 'gbC' || tmpPlay == 'G3'">First</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="4" v-show="tmpPlay == 'E' || tmpPlay == 'S1' || tmpPlay == 'S*' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'gbA' || tmpPlay == 'G1' || tmpPlay == 'gbB' || tmpPlay == 'G2' || tmpPlay == 'gbC' || tmpPlay == 'G3'">Second</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="5" v-show="tmpPlay == 'E' || tmpPlay == 'S1' || tmpPlay == 'S*' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'gbA' || tmpPlay == 'G1' || tmpPlay == 'gbB' || tmpPlay == 'G2' || tmpPlay == 'gbC' || tmpPlay == 'G3'">Third</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="6" v-show="tmpPlay == 'E' || tmpPlay == 'S1' || tmpPlay == 'S*' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'gbA' || tmpPlay == 'G1' || tmpPlay == 'gbB' || tmpPlay == 'G2' || tmpPlay == 'gbC' || tmpPlay == 'G3'">Shortstop</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="7" v-show="tmpPlay == 'E' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'D2' || tmpPlay == 'D**' || tmpPlay == 'D3' || tmpPlay == 'D***' || tmpPlay == 'T' || tmpPlay == 'T3' || tmpPlay == 'flyA' || tmpPlay == 'F1' || tmpPlay == 'flyB' || tmpPlay == 'F2' || tmpPlay == 'flyC' || tmpPlay == 'F3'">Left</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="8" v-show="tmpPlay == 'E' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'D2' || tmpPlay == 'D**' || tmpPlay == 'D3' || tmpPlay == 'D***' || tmpPlay == 'T' || tmpPlay == 'T3' || tmpPlay == 'flyA' || tmpPlay == 'F1' || tmpPlay == 'flyB' || tmpPlay == 'F2' || tmpPlay == 'flyC' || tmpPlay == 'F3'">Center</b-form-radio>
                <b-form-radio v-model="fielder" name="error-fielder-radios" class="pl-5" value="9" v-show="tmpPlay == 'E' || tmpPlay == 'S2' || tmpPlay == 'S**' || tmpPlay == 'D2' || tmpPlay == 'D**' || tmpPlay == 'D3' || tmpPlay == 'D***' || tmpPlay == 'T' || tmpPlay == 'T3' || tmpPlay == 'flyA' || tmpPlay == 'F1' || tmpPlay == 'flyB' || tmpPlay == 'F2' || tmpPlay == 'flyC' || tmpPlay == 'F3'">Right</b-form-radio>
              </b-form-group>
            </b-col>
            <b-col cols="6">
